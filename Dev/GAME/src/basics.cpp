...
bool detect_colision(NotPLayerCreature *npc )
{
	...
	//COLLISION AREAS
	for( cl = FirstCol -> next; cl -> next != nullptr; cl = cl -> next ) {
...
int BAS_LoadFonts(void)
{
	...
	if(Font14 || Font18 || Font20 || Font24 || Font2_14 || Font2_18 || Font2_20 || Font2_24) {
		return true;
	}
